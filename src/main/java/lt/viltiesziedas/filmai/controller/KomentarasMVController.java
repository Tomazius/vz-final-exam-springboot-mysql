...
public class KomentarasMVController {
    ...
    String issaugotiKomentara(Model model, @ModelAttribute Komentaras pridedamasKomentaras, @PathVariable int filmoId, @CurrentSecurityContext(expression = "authentication?.name") String username){
        System.out.println("pridedamasKomentaras = " + pridedamasKomentaras.getId());
        System.out.println("username = " + username);
        pridedamasKomentaras.setVartotojoKomentaras(vartotojasRepository.findByUsername(username));
